...
cifar10_dir = r'C:\\Users\\Erika Alvarez\\OneDrive\\Desktop\\P4_STDISCM\\cifar-10-python\\cifar-10-batches-py'  # adjust to your CIFAR-10 folder
...
for batch_idx in range(num_batches):
    ...
    time.sleep(0.2)  # short delay to simulate real-time training
